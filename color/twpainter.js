...
//		var canavasDiv = "<div id='BackgroundColorContainer'><div id='canavas'>";
		...
		{
			canavasDiv = canavasDiv + "<div id='canavas_box_" + index + "' class='canavas_box' name='canavas_box'  value='" + index +  "'></div>";
		}
		canavasDiv += "</div>";
	...
	function Brush(e)
	{
		...
		{
			if($(drawId).style.backgroundColor=="" || $(drawId).style.backgroundColor==null)
