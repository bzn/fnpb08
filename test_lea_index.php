...
$_SESSION['loginid']  = 4261;
$_SESSION['myteamid0801'] = 28;
...
array_multisort($a_points,SORT_DESC,SORT_NUMERIC,$a_teamid,$a_teamname,$a_money,$a_lastpoints,$a_userid,$a_nickname);
...
<table class="tableTitle">
    <tr class="dark">
        ...
        <td class="titleLink"><a href="http://npb.ohdada.com/discuz/">進入討論區</a></td>
  </tr>
...
<table class="inbox">
		 ...
		 ?>
            <tr>
                <td class="i"><?php echo $array_discuz[$i]['lastpost'];?></td>
				<td class="i"><?php echo $array_discuz[$i]['author'];?></td>
                <td><?php echo "<a href='".$array_discuz[$i]['link']."'>".$array_discuz[$i]['subject']."</a>";?></td>
            </tr>
          <?php
		  }
		  ?>
...
<table class="inbox">
            ...
            <tr>
                <td class="b" style="padding-top: 6px">● <a href="http://npb.club.tw/">日本職棒促進會<br>
                  <br>
                </a>● <a href="http://www.cc.rim.or.jp/~totto/">89CH 先発予想<br>
                <br>
