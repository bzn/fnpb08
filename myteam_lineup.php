...
$str = "SELECT * FROM myteam_score_log WHERE teamid='".$_SESSION['myteamid0801']."'";
$SQLObj0->RunSQL($str);
if($SQLObj0->LinkNext())
{
    ...
    <table class="v12 w100" cellspacing="0" cellpadding="0">
                ...
                <div class="v12 tleft" style="margin-bottom: 5px">隊伍資訊</div>
	                ...
	                <div class="tcenter"> <!-- IE Center -->
	                    <table class="listing margin_center v12" cellspacing="0" cellpadding="0" style="border-bottom: none">
	                            ...
	                            <tr>
	                            <td><span class="b">總積分:</span> <?php echo GetTeamPoints($SQLObj0,$_SESSION['myteamid0801']);?></td>
	                            <td><span class="b">總資產:</span> <?php echo $money;?></td>
	                            </tr>
	                            <tr><td><span class="b">分區排名:</span> <?php echo "第 ".GetTeamLeaRank($SQLObj0,$_SESSION['myteamid0801'])." 名 共 ".GetLeaCount($SQLObj0,$_SESSION['leaid'])." 隊";?></td>
	                            <td><span class="b">資產排名: </span>
	                              <?php 
	  //$teamcount = GetTeamCount($SQLObj0);
	  $teamcount = GetTeamCount($SQLObj0);
	  $m_rank = GetMoneyRank($SQLObj0,$_SESSION['myteamid0801']);
	  $last_m_rank = GetLastMoneyRank($SQLObj0,$_SESSION['myteamid0801']);
	  echo "第 ".$m_rank." 名";
	  ...
	  ?></td>
	                            ...
	                            <tr><td><span class="b">積分總排名:</span>
	                              <?php 
	  $p_rank = GetPointRank($SQLObj0,$_SESSION['myteamid0801']);
	  $last_p_rank = GetLastPointRank($SQLObj0,$_SESSION['myteamid0801']);
	  echo "第 ".$p_rank." 名 ";
...
<tr class="odd"><td class="tleft border"><select name="select1" id="select" class="v9 mar0 pad0">
  <?php 
